...
public class EsControllerLogProcessor {    
    ...
    public EsControllerLogProcessor(Flux<ControllerLog> controllerLogFlux, EsLogSender esLogSender) {
    ...
    @PostConstruct
    public void init() {
        disposable = controllerLogFlux.bufferTimeout(1000, Duration.ofSeconds(10), Schedulers.elastic()) 
